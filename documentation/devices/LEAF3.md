...
| --------- | --------------- | ------------ | --------- |
| POD2 | Vlan4094 | 10.1.253.1 | Port-Channel51 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | SPINE1_Ethernet3 | *trunk | *10,20,30,255 | *- | *- | 49 |
| Ethernet50 | SPINE2_Ethernet3 | *trunk | *10,20,30,255 | *- | *- | 49 |
| Ethernet51 | MLAG_PEER_LEAF4_Ethernet51 | *trunk | *- | *- | *['MLAG'] | 51 |
| Ethernet52 | MLAG_PEER_LEAF4_Ethernet52 | *trunk | *- | *- | *['MLAG'] | 51 |
...
interface Ethernet52
   description MLAG_PEER_LEAF4_Ethernet52
   no shutdown
   channel-group 51 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | SPINES_Po3 | switched | trunk | 10,20,30,255 | - | - | - | - | 49 | - |
| Port-Channel51 | MLAG_PEER_LEAF4_Po51 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan255 |  default  |  10.255.255.6/24  |  -  |  -  |  -  |  -  |  -  |
